...

{
    ...
    public class CategoryTest
    {
        ...
        public void UpdateOnlyName()
        {
            ...
            category.Update(newName.Name);

            category.Name.Should().Be(newName.Name);
        ...
        {
            var category = _categoryTestFixture.GetValidCategory();
            var invalidDescription = _categoryTestFixture.Faker.Lorem.Letter(256);
            Action action = () => category.Update(invalidDescription, "Category Ok Description");
            action.Should()
                .Throw<EntityValidationException>()
                .WithMessage("Name should be less or equal 255 characters long");
        }
